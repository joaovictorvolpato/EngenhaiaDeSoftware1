...
button_image = PhotoImage(
    file = relative_to_assets("button_image.png")
)

AVAI_piece = PhotoImage(
    file=relative_to_assets("AVAI.png"))

VASCO_piece = PhotoImage(
    file = relative_to_assets("VASCO.png")
)
